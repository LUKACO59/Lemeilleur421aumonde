...
class Lancer:
    """
    Class Lancer pour modéliser un lancer
    """
    def __init__(self):
...
def estsuite(r1):
    ...
    """
    Permet de savoir si le lancer est une suite 
    """
    a=tuple(r1.v2)
...
class Compareinplayer:
    """
    Class donnant le type et le nombre de jetons que rapporte le lancer
    """
...
class Joueur:
    """
    Class permettant de creer un joueur
    """
    ...
    def nlancer(self):
        """
        fonction qui permet de faire faire un lancer au joueur
        """
        self.lancer=Lancer()
...
class Comparemanche:
    """
    Cette class permet de comparer lequel des deux lancer est le gagnant,
    Renvoie None si les deux lancer sont exactement les même
    """
...
class Manche:
    """
    permet de faire une parti en entier
    """
    def __init__(self,j1,j2):
...
class Jeu:
    """
    sert à modéliser un jeu de 421
    """
...
def lancer_le_jeu(j1,j2):
    """
    Fonction qui permet de lancer le jeu en inserant les noms des deux joueur
    """
